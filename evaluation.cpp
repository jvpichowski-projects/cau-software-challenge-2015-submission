...
//        }
    ...
    int evaluateNormal(int playerId, Board board, bool qsearch)
    {
        ...
        u_int64_t moveFields = Tools::genMoveField(penguinPosWe[0], board.used) 
        ...
        allLinePoints += Tools::popCount(moveFields & Globals::threes) * Globals::Config::allLinePoints3;
        allLinePoints += Tools::popCount(moveFields & Globals::twos) * Globals::Config::allLinePoints2;
        allLinePoints += Tools::popCount(moveFields & Globals::ones) * Globals::Config::allLinePoints1;
        
        singleLinePoints += ((moveFields & Globals::threes) != 0) * Globals::Config::singleLinePoint3;
        singleLinePoints += ((moveFields & Globals::twos) != 0) * Globals::Config::singleLinePoint2;
        singleLinePoints += ((moveFields & Globals::ones) != 0) * Globals::Config::singleLinePoint1;
        
        moveFields = Tools::genMoveField(penguinPosOp[0], board.used) 
        ...
        reachPoints += Tools::popCount(reachFieldWe & Globals::twos) * Globals::Config::reachPoints2;
        reachPoints += Tools::popCount(reachFieldWe & Globals::ones) * Globals::Config::reachPoints1;
        reachPoints -= Tools::popCount(reachFieldOp & Globals::threes) * Globals::Config::reachPoints3;
        reachPoints -= Tools::popCount(reachFieldOp & Globals::twos) * Globals::Config::reachPoints2;
        reachPoints -= Tools::popCount(reachFieldOp & Globals::ones) * Globals::Config::reachPoints1;
        
        delete[] penguinPosWe;
        delete[] penguinPosOp;
        
        if(playerId != ID_WE){
            return -points*Globals::Config::points-reachPoints-allLinePoints-singleLinePoints;
        }
        return points*Globals::Config::points+reachPoints+allLinePoints+singleLinePoints;
